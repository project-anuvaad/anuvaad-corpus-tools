# this script is used to  crawl the data from hindi urls  and store it as list format
...
def get_data(df):
    ...
    for url_link_num in tqdm.tqdm(range(len(link_list))):
        try : 
            ...
            with open('thewire_hindi.csv', 'a') as f_object:
...
if __name__=='__main__':
    ...
    df=pd.read_csv('HI URLS/thewire_total_hi_urls.csv')
